...
void MatchingWizard::setupUI()
{
    ...
    // Source impedance
    inputLayout->addWidget(new QLabel(tr("Source Z (Ohm):")), 0, 0);
    ...
    // Load impedance
    inputLayout->addWidget(new QLabel(tr("Load Z (Ohm):")), 1, 0);
    ...
    // Z0
    inputLayout->addWidget(new QLabel(tr("Z0 (Ohm):")), 3, 0);
...
QString MatchingWizard::topologyName(MatchingTopology topo) const
{
    switch (topo) {
        ...
        case MatchingTopology::QuarterWave: return tr("Quarter-wave Transformer");
